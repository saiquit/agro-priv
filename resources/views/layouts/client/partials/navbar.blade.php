<nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
    <a href="{{ route('client.home', []) }}" class="navbar-brand p-0">
        <h1 class="text-primary">
            <img src="{{ asset('assets/img/Logo.png') }}" alt="{{ App\Models\Setting::getValue('site_name') }}">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto py-0">
            <a href="{{ route('client.home', []) }}"
                class="nav-item nav-link @if (request()->is('/')) active @endif">@lang('nav.home')</a>
        ...
        <div class="d-none d-xl-flex me-3">
            <div class="d-flex flex-column pe-3 border-end border-primary">
                ...
                <a href="tel:{{ App\Models\Setting::getValue('contact_phone_1') }}"><span class="text-primary">{{
                        App\Models\Setting::getValue('contact_phone_1') }}</span></a>
            </div>
        </div>
